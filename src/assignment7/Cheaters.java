...
public class Cheaters {
	...
	/**
	 * The following code is needed to give the GUI the data needed to generate the graph
	 */
	// GUI Inputs 
	...
	/**
	 * The following code represents the bulk of the model
	 * Processes directory files and outputs a similarity matrix
	 */
